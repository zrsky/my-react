...
export default class ETable extends React.Component{
    ...
    onSelectChange = (selectedRowKeys, selectedItem)=>{
        ...
        this.props.updateSelectedItem(selectedRowKeys, selectedItem?selectedItem:[], selectedId);
    }

    onSelectAll = (selected, selectedRows, changeRows) => {
        let selectedId = [], selectedKey = [];
        selectedRows.map((item, i) => {
            selectedId.push(item.id);
            selectedKey.push(i);
        })
        this.props.updateSelectedItem(selectedKey, selectedRows?selectedRows:[], selectedId);
    }
